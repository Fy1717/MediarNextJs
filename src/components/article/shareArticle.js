...
const ArticleShareStarter = () => {
    ...
    return (
        <>
            <div className="post-starter" 
                style={{ display: 'flex', alignItems: 'center', padding: '10px', border: '1px solid #ccc', borderRadius: '20px', marginBottom: '5px', marginTop: '20px' }}>
                ...
                <input
                    ...
                    onClick={openModal}
                    style={{ border: 'none', flex: '1', marginRight: '10px', marginLeft: '10px'}}
                />
            </div>
